...
const ITEMS = [
  {title: dates[0], data: [{hour: '12 PM', duration: '1h', title: 'Alumni Meet'}]},
  {
    title: dates[1],
    data: [
      {hour: '4 PM', duration: '1h', title: 'International Conference'},
      {hour: '5 PM', duration: 'All Day', title: 'Centenary Celebrations'}
    ]
  },
  {
    title: dates[2],
    data: [
      {hour: '1 PM', duration: '1h', title: 'International Conference'},
      {hour: '2 PM', duration: 'All Day', title: 'Holiday'},
      {hour: '3 PM', duration: '1h', title: 'Flower Show'}
    ]
  },
  {title: dates[4], data: [{}]},
  {
    title: dates[5],
    data: [
        {hour: '12 PM', duration: '1h', title: 'Run for Unity'},
        {hour: '4 PM', duration: '1h', title: 'International Conference'},
        {hour: '5 PM', duration: 'All Day', title: 'Centenary Celebrations'}
    ]
  },
  ...
  {title: dates[10], data: [{hour: '11 AM', duration: '1h', title: 'Yoga Day'}
]}
];
